...
var mix = function mix() {
  for (var _len = arguments.length, mixins = Array(_len), _key2 = 0; _key2 < _len; _key2++) {
...
var copyProperties = function copyProperties(target, source) {
  var prots = Object.getOwnPropertyNames(source);
  for (var _key in prots) {
    var key = prots[_key];
...
var _CoordsTransform = __webpack_require__(17);

var _CoordsTransform2 = _interopRequireDefault(_CoordsTransform);

var _LayerSwitcher = __webpack_require__(15);

var _LayerSwitcher2 = _interopRequireDefault(_LayerSwitcher);

var _MeasureTool = __webpack_require__(16);
...
var HMap = {};
HMap.version = __webpack_require__(19).version;
...
var _appDrag = __webpack_require__(13);
  ...
  _createClass(Interactions, [{
    ...
    value: function _addInteractions(params) {
      ...
      return new _constants.ol.interaction.defaults({
        ...
        zoomDelta: options['zoomDelta'] && typeof options['zoomDelta'] === 'number' ? options['zoomDelta'] : 1,
        zoomDuration: options['zoomDuration'] && typeof options['zoomDelta'] === 'number' ? options['zoomDuration'] : 300 }).extend([new _appDrag2.default.Drag()]);
    }
  }]);
...
var _Interactions = __webpack_require__(10);
  ...
  _createClass(BaseLayers, [{
    ...
    value: function _getXYZLayer(config) {
      ...
      var tileArcGISXYZ = new _constants.ol.source.XYZ({
        ...
        tileGrid: tileGrid,
        tileSize: this.tileSize,
        opaque: config['opaque'] === true ? config['opaque'] : false,
        tilePixelRatio: 1,
...
var CoordsTransform = function () {
  ...
  _createClass(CoordsTransform, [{
    ...
    key: 'bdtogcj02',
    value: function bdtogcj02(lon, lat) {
      var x = lon - 0.0065;
      var y = lat - 0.006;
...
module.exports = __webpack_require__(53)|| !__webpack_require__(24)(function(){
  var K = Math.random();
  // In FF throws only define methods
  __defineSetter__.call(null, K, function(){ /* empty */});
  delete __webpack_require__(23)[K];
});
...
__webpack_require__(33)(IteratorPrototype, __webpack_require__(26)('iterator'), function(){ return this; });
...
$export($export.P + $export.F * (__webpack_require__(67) != Object || !__webpack_require__(41)(arrayJoin)), 'Array', {
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(33)(proto, TO_PRIMITIVE, __webpack_require__(137));
...
$export($export.S + $export.F * !__webpack_require__(27), 'Object', {defineProperties: __webpack_require__(120)});
...
if(__webpack_require__(27) && (!CORRECT_NEW || __webpack_require__(24)(function(){
...
__webpack_require__(27) && $export($export.P + __webpack_require__(76), 'Object', {
...
$export($export.S, 'System', {global: __webpack_require__(23)});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5), __webpack_require__(315)))
